...
func main() {
	...
	log.Info("starting migrator (shared core)")
	...
	shutdownTelemetry, err := bootstrap.InitTelemetry(ctx, "go-dota2-analysis-migrator", cfg.Telemetry.Endpoint, cfg.Telemetry.SampleRate)
	if err != nil {
